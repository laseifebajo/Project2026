      ...
      <div className='max-padd-container'>
        ...
        <div className='flexBetween'>
          ...
          <div className='flex flex-1'>
            <Link to={"/"}>
            <img src={assets.logoImg} alt="logoImg" width={88}
            className='h-7' />
            <span className='text-black uppercase text-xs font-extrabold tracking-[6px] relative bottom-1'>GalwayRental</span>
            </Link>
          </div>
          {/*NAVBAR*/}
          <Navbar containerStyles={menuOpened ? "flex" : "hidden lg:flex"} />
          ...
          <div className='flex sm:flex-1 items-center sm:justify-end gap-x-4 sm:gap-x-8'>
            ...
            {/*Menu toggle*/}
            {menuOpened ? (
              <img src ={assets.close} alt="" className={'lg:hidden cursor-pointer text-xl'} />
            ) : (
              <img src ={assets.menu} alt="" className={'lg:hidden cursor-pointer text-xl'} />
            )}
          </div>
        </div>
      </div>
